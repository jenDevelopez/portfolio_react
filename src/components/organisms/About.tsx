    ...
    <Section title="Sobre mi">
      <div className="my-10">
        <p className="mb-2 sm:text-xl">
          Soy una desarrolladora que ha estado formandose tanto en el lado cliente como en el lado servidor. He estado aprendiendo distintas tecnologias desde el 2022. Y tomando experiencia en distintos proyectos
        </p>
        <p className="mb-2 sm:text-xl">
